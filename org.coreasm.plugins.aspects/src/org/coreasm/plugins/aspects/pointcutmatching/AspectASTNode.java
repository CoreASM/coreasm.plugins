 ...
 * @version	0.1 (alpha)
 * 
 * @brief	The class {@link org.coreasm.plugins.aspects.pointcutmatching.AspectASTNode} is a super type for all nodes used in the aspect-oriented CoreASM-Plugin.
 */
