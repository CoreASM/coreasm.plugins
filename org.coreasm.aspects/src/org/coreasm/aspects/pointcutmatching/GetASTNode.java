 ...
 *
 */
public class GetASTNode extends PointCutASTNode {

	private static final long serialVersionUID = 1L;
	private static final String NODE_TYPE = GetASTNode.class.getSimpleName();

	/**
	 * this constructor is needed to support duplicate
	 * @param self this object
	 */
	public GetASTNode(GetASTNode self){
		super(self);
	}

	public GetASTNode(ScannerInfo scannerInfo) {
		super(AoASMPlugin.PLUGIN_NAME, Node.OTHER_NODE, GetASTNode.NODE_TYPE, null, scannerInfo);
	}
